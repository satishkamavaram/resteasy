package com.satish.resteasy;
	 ...
	 */
	public class RestEasyServer implements AutoCloseable {
	    ...
	    private RestEasyServer(Object... objects) {
	     ...
	     * @throws IOException
	     */
	    public static RestEasyServer create(Object... objects) throws IOException {
	     ...
	     * @throws IOException
	     */
	    public static RestEasyServer create(SecurityDomain securityDomain, Object... objects) throws IOException {

	    	RestEasyServer inMemoryRestServer = new RestEasyServer(objects);
